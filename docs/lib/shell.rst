...
The Zigbee shell commands are implemented using Zephyr's `Shell`_ interface.
...
For more information, see `Testing and optimization`_ in the |NCS| documentation.
