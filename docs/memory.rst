...
.. tabs::
   ...
   .. tab:: nRF54L10
      ...
      The following table lists memory requirements for samples running on the `nRF54L10 emulation on the nRF54L15 DK <Developing with nRF54L Series_>`_ (`nrf54l15dk`_).
   ...
   .. tab:: nRF54L05
      ...
      The following table lists memory requirements for samples running on the `nRF54L05 emulation on the nRF54L15 DK <Developing with nRF54L Series_>`_ (`nrf54l15dk`_).
